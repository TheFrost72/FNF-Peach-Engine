...
class Main {
	...
	public static function initCommands() {
		commands = [
			{
				names: ["setup"],
				doc: "Installs (or updates) all libraries required for the engine.",
				func: Setup.main,
				dDoc: [
					"Usage: setup [--git]",
					"",
					"By default, this command installs official libraries from Haxelib.",
					"Use --git to install libraries directly from Git repositories.",
					"",
					"--git : Use Git-based libraries (development).",
